  ...
  test: {
    coverage: {
      ...
      include: [
        ...
        "src/modules/xp/xp.routes.ts",
        "src/modules/xp/xp.service.ts",
        "src/modules/xp/xp.repository.ts",
        ...
        "src/shared/utils/handle.utils.ts",
        "src/shared/utils/admin-url.utils.ts",
        ...
        "src/modules/platform-roles/**/*.ts",
        "src/modules/admin-invites/**/*.ts",
