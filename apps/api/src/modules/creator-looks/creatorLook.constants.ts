...
export const TRENDING_HYBRID_MIN_SCORED_POOL_SIZE = 20;
...
export const FOR_YOU_FOLLOWED_RECENCY_WINDOW_DAYS = 7;
export const FOR_YOU_FOLLOWED_MAX_INJECTED = 20;
export const FOR_YOU_FOLLOWED_SLOT_INTERVAL = 5;
export const FOR_YOU_ANONYMOUS_TRENDING_BOOST = 0.3;
export const FOR_YOU_LEGACY_POSITION_DECAY = 0.97;
...
export const TAG_TREND_SCORE_RECOMPUTE_LOCK_TTL_MS = 30_000;
