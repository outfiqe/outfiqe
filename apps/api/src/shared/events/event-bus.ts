...
export const DomainEvents = {
  ...
  LOOK_COMMENT_REPLIED: "look.comment.replied",
  ...
  CRM_MEMBER_JOINED: "crm.member.joined",
  CRM_MEMBERSHIP_ENDED: "crm.membership.ended",
  CRM_INVOICE_OPENED: "crm.invoice.opened",
  CRM_SUBSCRIPTION_LAPSED: "crm.subscription.lapsed",
