  ...
  test: {
    coverage: {
      ...
      include: [
        ...
        "src/features/creator-dashboard/components/**",
        "src/features/creator-dashboard/hooks/**",
        "src/features/creator-dashboard/schemas/**",
        "src/features/creator-dashboard/utils/**",
