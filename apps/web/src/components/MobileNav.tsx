          ...
          <div className="fixed inset-x-0 top-[var(--site-header-height,3.5rem)] z-40 max-h-[calc(100dvh-var(--site-header-height,3.5rem))] overflow-y-auto border-b border-border bg-background px-6 py-4 shadow-lg lg:hidden">
            <nav className="flex flex-col gap-0.5 text-sm">
              ...
              <Button
                ...
                className="h-auto justify-between rounded-lg px-2 py-2 font-normal text-muted-foreground hover:text-foreground"
              >
                Brand leaderboard
                <ChevronDown
            ...
            <div className="mt-4 flex flex-col gap-0.5 border-t border-border pt-4 text-sm">
              ...
              <Button
                ...
                className="h-auto justify-start gap-2.5 rounded-lg px-2 py-2 font-normal text-muted-foreground hover:text-foreground"
              >
